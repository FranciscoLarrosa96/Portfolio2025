...
export class AppComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  projects: Project[] = [
    ...
    {
      name: 'Gatarsis',
      image: 'assets/img/gatarsis-preview.png',
      imageWidth: 1852,
      imageHeight: 902,
      tone: 'blue',
      domain: 'Gatarsis',
      categoryEs: 'Impacto social · Aplicación web',
      categoryEn: 'Social impact · Web application',
      descEs:
        'Plataforma solidaria para visibilizar rescates animales, compartir su evolución y facilitar distintas formas de colaboración para cubrir gastos veterinarios.',
      descEn:
        'A nonprofit platform to showcase animal rescues, share their progress, and enable different ways to help cover veterinary costs.',
      stack: ['Angular 22', 'TypeScript', 'Tailwind CSS'],
      githubUrl: 'https://github.com/fran-larrosa-7id/rescatadosTandil',
      liveUrl: 'https://fran-larrosa-7id.github.io/rescatadosTandil/',
    },
    {
      name: 'BioMind',
